...
## Task division
- **Thành viên 1 phụ trách chính**: Sender, đóng gói packet và test sender.
- **Thành viên 2 phụ trách chính**: Receiver, giải mã và viết tài liệu threat model.
- **Phần làm chung**: thiế kế protocol, kiểm thử tích hợp, chạy demo và ghi log.
